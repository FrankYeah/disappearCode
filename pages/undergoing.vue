    ...
    return {
      ...
      reports: [
        ...
        },
        {
          ...
          date: '2022年10月',
          head: '尋訪三沙灣、完成專欄文章',
          text: '關於建造始末及郭老中醫的傳奇故事，資料已足夠，但關於當地居民記憶，以及當時熱鬧情景，略有不足，因此事務所安排了一次三沙灣地區尋訪，隨機訪問當地居民對於十八羅漢洞的記憶，幸而訪問到當地耆老李大哥（當時恰巧住在聖濟宮下方的民房），得知一些當時建造趣聞。也透過這次尋訪，感受到當地人無不知曉順泰堂郭老中醫善舉事蹟，以及回憶十八羅漢洞時，眼中激起興奮的微光，完成了專欄文章撰寫：<a class="under-a" href="https://drive.google.com/file/d/1ll7dyI35tMhOXv7Cg3vGTBodGiYZj763/view?usp=sharing" target="_blank">（完整文章）</a>原搜查計畫應到此結束，但這整段歷程的所見所聞，令我們也產生出一股不捨，我們進入深沉地思考與討論。'
        },
        {
          isShow: false,
          date: '2022年11月',
        ...
        },
        {
          ...
          head: '十八羅漢洞限定展覽：消失的洞',
          text: `
          📍展覽日期：10/28、10/29、11/4、11/5<br><br>
          📍開放時間：13:00-19:00<br><br>
          📍展覽地點：基隆信二路防空洞（信二立體停車場對面）<br><br>
          📍展覽說明：<br><br>
          從金火仙的羅漢洞出發，「消失事務所」試圖拉出幾條閱讀的提問：文本的詮釋與敘事手法的改變、娛樂與接受資訊的形式轉變、洞穴的功能演變等。十八羅漢洞的「消失」，不單指實體的洞穴，更包含某個時代價值的終結。羅漢洞建成至今的數十年閒，台灣社會從單一視角的單向環境，發展成多元視角的多維並置。<br><br>
          「消失的洞」也許提醒我們：每一個消失都有意義。每個時代，都有時代的價值，用多元的視角再次爬梳過去，在尋找消失的過程中，也尋找過去之於現代的價值與意義。<br><br>
          `
        }
      ]
    }
